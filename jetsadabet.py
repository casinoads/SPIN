...
class jetsadabet:
    def NextRound():
        r = requests.get('https://aapsite.com/stock1jetsadabetresult.php')
    ...
    while True:
        ...
        # json.dump({'jetsadabet':RoundNext}, Round_file, indent = 6)
        # Round_file.close()

        # with open('jetsadabet.json', 'w', encoding ='utf8') as json_file:
