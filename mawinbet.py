...
# req = urllib.request.Request('https://aapsite.com/stock1mawinbetresult.php', headers={'User-Agent': 'Mozilla/5.0'})
...
class mawinbet:
    def NextRound():
        r = requests.get('https://aapsite.com/stock1mawinbetresult.php')
    ...
    if RoundNext == ResRound:
        ...
        # json.dump({'mawinbet':RoundNext}, Round_file, indent = 6)
        # Round_file.close()

        # with open('mawinbet.json', 'w', encoding ='utf8') as json_file:
